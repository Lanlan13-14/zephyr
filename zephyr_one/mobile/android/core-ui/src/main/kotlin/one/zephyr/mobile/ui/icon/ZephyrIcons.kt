...
object ZephyrIcons {
    ...
    /* `viewport` exists because the web app's system SVGs are not all drawn on a
     * 24 square: Debian's paths span roughly 0..20 and Arch's span 0..23.395.
     * Forcing those into a 24 viewport stretches them, which is the distortion
     * One showed on connection cards. The drawn box stays 24dp either way. */
