...
object MobileApiPaths {
    ...
    const val POST_MOBILE_V1_DEVICES_PROOF_CHALLENGE: String = "/api/mobile/v1/devices/proof-challenge"
    ...
    const val GET_MOBILE_V1_SYNC_WAKE: String = "/api/mobile/v1/sync/wake"
    ...
    const val POST_MOBILE_V1_BLOBS_UPLOADS: String = "/api/mobile/v1/blobs/uploads"
    const val GET_MOBILE_V1_BLOBS_UPLOADS_BY: String = "/api/mobile/v1/blobs/uploads/{uploadId}"
