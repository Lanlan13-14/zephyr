...
private actor ScriptedSyncTransport: SyncTransport {
    private let capabilitiesValue: MobileCapabilitiesResponse = decoded([
        ...
        "limits": [
            ...
            "defaultPageSize": 200,
            "minIntervalSec": 30,
            "maxIntervalSec": 86_400,
            "blobChunkBytes": 4 * 1_024 * 1_024,
            "maxBlobBytes": 512 * 1_024 * 1_024,
            "tombstoneRetentionDays": 180,
            "appliedOpRetentionDays": 180,
        ],
        "serverId": "server-1",
        "auth": [
            ...
            "proofSkewSec": 30,
            "challengeTtlSec": 30,
            "challengeMaxActivePerDevice": 4,
            "challengeMaxIssuesPerMinute": 60,
            "signatureFormat": "P1363",
            "encryptionAlg": "ML-KEM-768",
            "signingAlg": "ES256",
        ],
        "serverEncryption": NSNull(),
        "features": [
