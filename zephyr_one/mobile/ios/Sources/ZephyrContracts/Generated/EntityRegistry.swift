...
public enum EntityRegistry {
    ...
    public static let entities: [SyncEntitySpec] = [
        SyncEntitySpec(
            ...
            editableFields: ["name", "host", "port", "protocol", "username", "remark", "tags", "connectionMode", "proxyId", "jumpHostId", "jumpHostIds", "sshKeyId", "icon", "rdpSoundMode", "rdpClipboard", "rdpMicrophone", "rdpCamera", "rdpStorage", "rdpLocation", "rdpResolution", "rdpQuality", "rdpFps", "rdpTouchMode", "rdpTouchSensitivity", "rdpDomain", "encoding"],
            secretFields: ["password", "privateKey"],
            serverAuthorityFields: ["ownerUserId", "createdByUserId", "revision", "createdAt", "updatedAt", "lastConnectedAt", "iconSource", "visibility"],
