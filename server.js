...
app.post('/api/rdp/telemetry', requireUser, (req, res) => {
    ...
    const safe = {
        ...
        telemetryReason: String(body.telemetryReason || '').slice(0, 128),
        resolutionMode: String(body.resolutionMode || '').slice(0, 32),
        qualityMode: String(body.qualityMode || '').slice(0, 32),
        fpsValue: Math.max(0, Number(body.fpsValue) || 0),
        desktopWidth: Math.max(0, Number(body.desktopWidth) || 0),
        desktopHeight: Math.max(0, Number(body.desktopHeight) || 0),
        desiredWidth: Math.max(0, Number(body.desiredWidth) || 0),
        desiredHeight: Math.max(0, Number(body.desiredHeight) || 0),
        requestedWidth: Math.max(0, Number(body.requestedWidth) || 0),
        requestedHeight: Math.max(0, Number(body.requestedHeight) || 0),
        previousWidth: Math.max(0, Number(body.previousWidth) || 0),
        previousHeight: Math.max(0, Number(body.previousHeight) || 0),
        width: Math.max(0, Number(body.width) || 0),
        height: Math.max(0, Number(body.height) || 0),
        resizeAwaitingReset: Boolean(body.resizeAwaitingReset),
        ...
        avc420RegionEvents: Math.max(0, Number(body.avc420RegionEvents) || 0),
        avc420RegionRects: Math.max(0, Number(body.avc420RegionRects) || 0),
        avc420RegionPixels: Math.max(0, Number(body.avc420RegionPixels) || 0),
        avc420FramePixels: Math.max(0, Number(body.avc420FramePixels) || 0),
        avc420LastRegionPixels: Math.max(0, Number(body.avc420LastRegionPixels) || 0),
        avc420LastFramePixels: Math.max(0, Number(body.avc420LastFramePixels) || 0),
        avc420FullUploads: Math.max(0, Number(body.avc420FullUploads) || 0),
        avc444Events: Math.max(0, Number(body.avc444Events) || 0),
        avc444RejectedRegions: Math.max(0, Number(body.avc444RejectedRegions) || 0),
        ...
        renderQueueDepth: Math.max(0, Number(body.renderQueueDepth) || 0),
        renderQueueBlocked: Boolean(body.renderQueueBlocked),
        renderQueueMaxDepth: Math.max(0, Number(body.renderQueueMaxDepth) || 0),
        renderQueueApplied: Math.max(0, Number(body.renderQueueApplied) || 0),
        renderQueueSkipped: Math.max(0, Number(body.renderQueueSkipped) || 0),
        schedulerMode: String(body.schedulerMode || '').slice(0, 64),
        schedulerTargetFps: Math.max(0, Number(body.schedulerTargetFps) || 0),
        schedulerEffectiveFps: Math.max(0, Number(body.schedulerEffectiveFps) || 0),
        schedulerIntervalMs: Math.max(0, Number(body.schedulerIntervalMs) || 0),
        schedulerCallbacks: Math.max(0, Number(body.schedulerCallbacks) || 0),
        schedulerCallbacksPerSecond: Math.max(0, Number(body.schedulerCallbacksPerSecond) || 0),
        presentsPerSecond: Math.max(0, Number(body.presentsPerSecond) || 0),
        presentedFramesPerSecond: Math.max(0, Number(body.presentedFramesPerSecond) || 0),
        decodedOutputsPerSecond: Math.max(0, Number(body.decodedOutputsPerSecond) || 0),
        videoDisplayWidth: Math.max(0, Number(body.videoDisplayWidth) || 0),
        videoDisplayHeight: Math.max(0, Number(body.videoDisplayHeight) || 0),
        videoCodedWidth: Math.max(0, Number(body.videoCodedWidth) || 0),
        videoCodedHeight: Math.max(0, Number(body.videoCodedHeight) || 0),
        videoSurfaceWidth: Math.max(0, Number(body.videoSurfaceWidth) || 0),
        videoSurfaceHeight: Math.max(0, Number(body.videoSurfaceHeight) || 0),
        videoWireLeft: Number(body.videoWireLeft) || 0,
        videoWireTop: Number(body.videoWireTop) || 0,
        videoWireRight: Number(body.videoWireRight) || 0,
        videoWireBottom: Number(body.videoWireBottom) || 0,
