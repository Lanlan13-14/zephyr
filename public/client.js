...
import { t, initI18n, setLocale, getLocale, applyDomI18n } from './i18n/runtime.js?v=20260727-ai-settings-fix1';
...
const loginSelectMotion = {
    ...
    _ensure() {
        ...
        return import('./vendor/zephyr-motion/index.js?v=20260727-ai-settings-fix1')
            .then(async (mod) => {
