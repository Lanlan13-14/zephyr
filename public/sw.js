const CACHE_NAME = 'zephyr-static-20260924-os-probe';
const PRECACHE = [
    '/app.js?v=20260924-os-probe',
    '/style.css?v=20260924-os-probe',
    '/i18n/runtime.js?v=20260924-os-probe',
    '/i18n/locales/en.json?v=20260924-os-probe',
    '/i18n/locales/zh-CN.json?v=20260924-os-probe',
    '/activity-i18n.js?v=20260924-os-probe',
    '/notes.js?v=20260924-os-probe',
    '/preview-mock.js?v=20260924-os-probe',
    '/theme-runtime.js?v=20260615-visual-color-picker',
    '/terminal.js?v=20260924-os-probe',
    '/telnet-terminal.js?v=20260924-os-probe',
