const CACHE_NAME = 'zephyr-static-20260916-agent-devices1';
const PRECACHE = [
    '/app.js?v=20260916-agent-devices1',
    '/style.css?v=20260916-agent-devices1',
    '/i18n/runtime.js?v=20260916-agent-devices1',
    '/i18n/locales/en.json?v=20260916-agent-devices1',
    '/i18n/locales/zh-CN.json?v=20260916-agent-devices1',
    '/activity-i18n.js?v=20260916-agent-devices1',
    '/notes.js?v=20260916-agent-devices1',
    '/preview-mock.js?v=20260916-agent-devices1',
    '/theme-runtime.js?v=20260615-visual-color-picker',
    '/terminal.js?v=20260916-agent-devices1',
    '/telnet-terminal.js?v=20260916-agent-devices1',
