...
const PRECACHE = [
    ...
    '/i18n/runtime.js?v=20260925-ai-layout',
    '/i18n/locales/en.json?v=20260925-ai-layout',
    '/i18n/locales/zh-CN.json?v=20260925-ai-layout',
    '/activity-i18n.js?v=20260925-ai-layout',
    '/notes.js?v=20260925-ai-layout',
    '/preview-mock.js?v=20260925-ai-layout',
    '/theme-runtime.js?v=20260615-visual-color-picker',
    '/terminal.js?v=20260925-ai-layout',
    '/telnet-terminal.js?v=20260925-ai-layout',
