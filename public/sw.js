const CACHE_NAME = 'zephyr-static-20260919-direct-ssh-no-jump';
const PRECACHE = [
    '/app.js?v=20260919-direct-ssh-no-jump',
    ...
    '/activity-i18n.js?v=20260919-direct-ssh-no-jump',
    '/notes.js?v=20260919-direct-ssh-no-jump',
    '/preview-mock.js?v=20260919-direct-ssh-no-jump',
