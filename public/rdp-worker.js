import { RdpGpuSurfaceCompositor } from './rdp-renderer.js?v=20260719-settings-apply1';
import { RdpAvc420Decoder, RdpAvc444Decoder } from './rdp-video-decoder.js?v=20260719-settings-apply1';
import { createSynchronousBitmapUploader } from './rdp-wasm-memory.js?v=20260719-settings-apply1';
import { createWorkerFrameScheduler } from './rdp-worker-frame-scheduler.js?v=20260719-settings-apply1';
import { loadGoRuntime, instantiateGoWasm } from './rdp-wasm-runtime.js?v=20260719-settings-apply1';
...
async function loadGoWasm() {
    ...
    const { go, result } = await instantiateGoWasm(GoRuntime, {
        wasmUrl: './vendor/rdp-wasm/main.wasm?v=20260719-settings-apply1',
