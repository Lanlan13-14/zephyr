...
var di = globalThis.performance && typeof globalThis.performance.now == "function";
var st = class n5 {
  static create(t) {
    return new n5(t);
  }
...
var S = class {
  ...
  get event() {
    return this._event ?? (this._event = (t, e, r) => {
      ...
      e && (t = t.bind(e));
      let i = new be(t), s, a;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (i.stack = Oe.create(), s = this._leakageMon.check(i.stack, this._size + 1)), Sr && (i.stack = a ?? Oe.create()), this._listeners ? this._listeners instanceof be ? (this._deliveryQueue ?? (this._deliveryQueue = new Wt()), this._listeners = [this._listeners, i]) : this._listeners.push(i) : (this._options?.onWillAddFirstListener?.(this), this._listeners = i, this._options?.onDidAddFirstListener?.(this)), this._size++;
      let l = J(() => {
...
var X = j("BufferService");
var Dr = j("CoreMouseService");
var dt = j("CoreService");
var Ar = j("CharsetService");
var Or = j("InstantiationService");
var ht = j("LogService");
var Y = j("OptionsService");
var Rr = j("OscLinkService");
var wr = j("UnicodeService");
var Ns = j("DecorationService");
var zt = class {
  constructor(...t) {
...
var vi = { trace: 0, debug: 1, info: 2, warn: 3, error: 4, off: 5 };
var gi = "xterm.js: ";
...
var pt = typeof process < "u" && "title" in process;
var bt = pt ? "node" : navigator.userAgent;
var qt = pt ? "node" : navigator.platform;
var Qs = bt.includes("Firefox");
var Js = bt.includes("Edge");
var Zs = /^((?!chrome|android).)*safari/i.test(bt);
var kr = ["Macintosh", "MacIntel", "MacPPC", "Mac68K"].includes(qt);
var en = ["Windows", "Win16", "Win32", "WinCE"].includes(qt);
var tn = qt.indexOf("Linux") >= 0;
var rn = /\bCrOS\b/.test(bt);
var _t = class {
  constructor() {
    this._tasks = [];
    this._i = 0;
...
var Br = !pt && "requestIdleCallback" in window ? jt : $t;
...
var Ur = Object.freeze({ insertMode: false });
var Wr = Object.freeze({ applicationCursorKeys: false, applicationKeypad: false, bracketedPasteMode: false, cursorBlink: void 0, cursorStyle: void 0, origin: false, reverseWraparound: false, sendFocus: false, synchronizedOutput: false, wraparound: true });
...
var Gr = { NONE: { events: 0, restrict: () => false }, X10: { events: 1, restrict: (n10) => n10.button === 4 || n10.action !== 1 ? false : (n10.ctrl = false, n10.alt = false, n10.shift = false, true) }, VT200: { events: 19, restrict: (n10) => n10.action !== 32 }, DRAG: { events: 23, restrict: (n10) => !(n10.action === 32 && n10.button === 3) }, ANY: { events: 31, restrict: (n10) => true } };
function Jt(n10, t) {
...
var er = [[768, 879], [1155, 1158], [1160, 1161], [1425, 1469], [1471, 1471], [1473, 1474], [1476, 1477], [1479, 1479], [1536, 1539], [1552, 1557], [1611, 1630], [1648, 1648], [1750, 1764], [1767, 1768], [1770, 1773], [1807, 1807], [1809, 1809], [1840, 1866], [1958, 1968], [2027, 2035], [2305, 2306], [2364, 2364], [2369, 2376], [2381, 2381], [2385, 2388], [2402, 2403], [2433, 2433], [2492, 2492], [2497, 2500], [2509, 2509], [2530, 2531], [2561, 2562], [2620, 2620], [2625, 2626], [2631, 2632], [2635, 2637], [2672, 2673], [2689, 2690], [2748, 2748], [2753, 2757], [2759, 2760], [2765, 2765], [2786, 2787], [2817, 2817], [2876, 2876], [2879, 2879], [2881, 2883], [2893, 2893], [2902, 2902], [2946, 2946], [3008, 3008], [3021, 3021], [3134, 3136], [3142, 3144], [3146, 3149], [3157, 3158], [3260, 3260], [3263, 3263], [3270, 3270], [3276, 3277], [3298, 3299], [3393, 3395], [3405, 3405], [3530, 3530], [3538, 3540], [3542, 3542], [3633, 3633], [3636, 3642], [3655, 3662], [3761, 3761], [3764, 3769], [3771, 3772], [3784, 3789], [3864, 3865], [3893, 3893], [3895, 3895], [3897, 3897], [3953, 3966], [3968, 3972], [3974, 3975], [3984, 3991], [3993, 4028], [4038, 4038], [4141, 4144], [4146, 4146], [4150, 4151], [4153, 4153], [4184, 4185], [4448, 4607], [4959, 4959], [5906, 5908], [5938, 5940], [5970, 5971], [6002, 6003], [6068, 6069], [6071, 6077], [6086, 6086], [6089, 6099], [6109, 6109], [6155, 6157], [6313, 6313], [6432, 6434], [6439, 6440], [6450, 6450], [6457, 6459], [6679, 6680], [6912, 6915], [6964, 6964], [6966, 6970], [6972, 6972], [6978, 6978], [7019, 7027], [7616, 7626], [7678, 7679], [8203, 8207], [8234, 8238], [8288, 8291], [8298, 8303], [8400, 8431], [12330, 12335], [12441, 12442], [43014, 43014], [43019, 43019], [43045, 43046], [64286, 64286], [65024, 65039], [65056, 65059], [65279, 65279], [65529, 65531]];
var Ei = [[68097, 68099], [68101, 68102], [68108, 68111], [68152, 68154], [68159, 68159], [119143, 119145], [119155, 119170], [119173, 119179], [119210, 119213], [119362, 119364], [917505, 917505], [917536, 917631], [917760, 917999]];
var M;
function yi(n10, t) {
...
var xt = class {
  ...
  charProperties(t, e) {
    ...
    if (i) {
      let s = z.extractWidth(e);
      s === 0 ? i = false : s > r && (r = s);
    }
    return z.createPropertyValue(0, r, i);
  }
};
var z = class n8 {
  constructor() {
...
var P;
((p) => (p.NUL = "\0", p.SOH = "", p.STX = "", p.ETX = "", p.EOT = "", p.ENQ = "", p.ACK = "", p.BEL = "\x07", p.BS = "\b", p.HT = "	", p.LF = `
`, p.VT = "\v", p.FF = "\f", p.CR = "\r", p.SO = "", p.SI = "", p.DLE = "", p.DC1 = "", p.DC2 = "", p.DC3 = "", p.DC4 = "", p.NAK = "", p.SYN = "", p.ETB = "", p.CAN = "", p.EM = "", p.SUB = "", p.ESC = "\x1B", p.FS = "", p.GS = "", p.RS = "", p.US = "", p.SP = " ", p.DEL = "\x7F"))(P || (P = {}));
var ke;
...
var Oi = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/;
var Ri = /^[\da-f]+$/;
function sr(n10) {
  if (!n10) return;
...
var Ct = class extends A {
  ...
  print(e, r, i) {
    ...
    for (let _ = r; _ < i; ++_) {
      ...
      a = z.extractWidth(d);
      let R = z.extractShouldJoin(d), w = R ? z.extractWidth(v) : 0;
  ...
  repeatPrecedingCharacter(e) {
    ...
    if (!r) return true;
    let i = e.params[0] || 1, s = z.extractWidth(r), a = this._activeBuffer.x - s, c = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(a), u = new Uint32Array(c.length * i), m = 0;
  ...
  requestMode(e, r) {
    let i;
    ((E) => (E[E.NOT_RECOGNIZED = 0] = "NOT_RECOGNIZED", E[E.SET = 1] = "SET", E[E.RESET = 2] = "RESET", E[E.PERMANENTLY_SET = 3] = "PERMANENTLY_SET", E[E.PERMANENTLY_RESET = 4] = "PERMANENTLY_RESET"))(i || (i = {}));
  ...
  write(e, r) {
    ...
    if (!this._writeBuffer.length) {
      if (this._bufferOffset = 0, this._didUserInput) {
        this._didUserInput = false, this._pendingData += e.length, this._writeBuffer.push(e), this._callbacks.push(r), this._innerWrite();
        return;
      }
