...
export function rdp_audin_data(_data: Uint8Array): void;

export function rdp_camera_frame(_data: Uint8Array, _is_key: boolean): void;

export function rdp_clipboard_changed(text: string): Promise<void>;

export function rdp_connect(proxy_ws_url: string, host: string, port: number, domain: string, user: string, password: string, width: number, height: number, _swap_alt_meta: boolean, _mic_enabled: boolean, _location_enabled: boolean, _storage_enabled: boolean, _camera_enabled: boolean, _h264_supported: boolean, _wallpaper: boolean): Promise<void>;

export function rdp_disconnect(): void;

export function rdp_download_server_file(_index: number, _callback: Function): void;

export function rdp_fs_attach_drive(agent_id: string, drive_name: string, read_only: boolean): number;

export function rdp_fs_detach_drive(_agent_id: string): void;

export function rdp_fs_list_drives(): Array<any>;

export function rdp_get_server_files(): Array<any>;

export function rdp_key_down(scancode: number, _extended: boolean): void;

export function rdp_key_up(scancode: number, _extended: boolean): void;

export function rdp_location_data(_lat: number, _lon: number, _alt: any, _accuracy: number, _speed: any, _heading: any): void;

export function rdp_mouse_down(button: number, x: number, y: number): void;

export function rdp_mouse_h_scroll(delta: number, x: number, y: number): void;

export function rdp_mouse_move(x: number, y: number): void;

export function rdp_mouse_up(button: number, x: number, y: number): void;

export function rdp_mouse_wheel(delta: number, x: number, y: number): void;

export function rdp_notify_files_changed(): void;

export function rdp_resize_display(width: number, height: number): void;
...
export interface InitOutput {
    ...
    readonly rdp_connect: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number) => any;
    readonly rdp_disconnect: () => void;
    readonly rdp_mouse_down: (a: number, b: number, c: number) => void;
    readonly rdp_mouse_up: (a: number, b: number, c: number) => void;
    readonly rdp_key_down: (a: number, b: number) => void;
    readonly rdp_key_up: (a: number, b: number) => void;
    readonly rdp_clipboard_changed: (a: number, b: number) => any;
    readonly rdp_notify_files_changed: () => void;
    readonly rdp_fs_attach_drive: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly rdp_fs_detach_drive: (a: number, b: number) => void;
    readonly rdp_audin_data: (a: number, b: number) => void;
    readonly rdp_camera_frame: (a: number, b: number, c: number) => void;
    readonly rdp_resize_display: (a: number, b: number) => void;
    readonly rdp_download_server_file: (a: number, b: any) => void;
    readonly rdp_mouse_wheel: (a: number, b: number, c: number) => void;
    readonly rdp_get_server_files: () => any;
    readonly rdp_fs_list_drives: () => any;
    readonly rdp_mouse_h_scroll: (a: number, b: number, c: number) => void;
    readonly rdp_mouse_move: (a: number, b: number) => void;
    readonly rdp_location_data: (a: number, b: number, c: any, d: number, e: any, f: any) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__hd61fc87c188b81b0: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h5ac8ee271e8fa147: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd_3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h78dca7c1a7923583: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h858026b36b08274a: (a: number, b: number) => void;
