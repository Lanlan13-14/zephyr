/* @ts-self-types="./rdp_client_wasm.d.ts" */
 ...
 */
export function rdp_audin_data(_data) {
    const ptr0 = passArray8ToWasm0(_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.rdp_audin_data(ptr0, len0);
}

/**
 * @param {Uint8Array} _data
 * @param {boolean} _is_key
 */
export function rdp_camera_frame(_data, _is_key) {
    const ptr0 = passArray8ToWasm0(_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.rdp_camera_frame(ptr0, len0, _is_key);
}
 ...
 * @returns {Promise<void>}
 */
export function rdp_clipboard_changed(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.rdp_clipboard_changed(ptr0, len0);
    return ret;
}

/**
 * @param {string} proxy_ws_url
 * @param {string} host
 * @param {number} port
 * @param {string} domain
 * @param {string} user
 ...
 * @param {number} width
 * @param {number} height
 * @param {boolean} _swap_alt_meta
 * @param {boolean} _mic_enabled
 * @param {boolean} _location_enabled
 * @param {boolean} _storage_enabled
 * @param {boolean} _camera_enabled
 * @param {boolean} _h264_supported
 * @param {boolean} _wallpaper
 * @returns {Promise<void>}
 */
export function rdp_connect(proxy_ws_url, host, port, domain, user, password, width, height, _swap_alt_meta, _mic_enabled, _location_enabled, _storage_enabled, _camera_enabled, _h264_supported, _wallpaper) {
    const ptr0 = passStringToWasm0(proxy_ws_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const ret = wasm.rdp_connect(ptr0, len0, ptr1, len1, port, ptr2, len2, ptr3, len3, ptr4, len4, width, height, _swap_alt_meta, _mic_enabled, _location_enabled, _storage_enabled, _camera_enabled, _h264_supported, _wallpaper);
    return ret;
}

export function rdp_disconnect() {
    wasm.rdp_disconnect();
}
 ...
 */
export function rdp_download_server_file(_index, _callback) {
    wasm.rdp_download_server_file(_index, _callback);
}
 ...
 * @returns {number}
 */
export function rdp_fs_attach_drive(agent_id, drive_name, read_only) {
    const ptr0 = passStringToWasm0(agent_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(drive_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.rdp_fs_attach_drive(ptr0, len0, ptr1, len1, read_only);
    return ret >>> 0;
}

/**
 * @param {string} _agent_id
 */
export function rdp_fs_detach_drive(_agent_id) {
    const ptr0 = passStringToWasm0(_agent_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.rdp_fs_detach_drive(ptr0, len0);
}

/**
 * @returns {Array<any>}
 */
export function rdp_fs_list_drives() {
    const ret = wasm.rdp_fs_list_drives();
    return ret;
}
 ...
 * @returns {Array<any>}
 */
export function rdp_get_server_files() {
    const ret = wasm.rdp_get_server_files();
    return ret;
}

/**
 * @param {number} scancode
 * @param {boolean} _extended
 */
export function rdp_key_down(scancode, _extended) {
    wasm.rdp_key_down(scancode, _extended);
}
 ...
 * @param {boolean} _extended
 */
export function rdp_key_up(scancode, _extended) {
    wasm.rdp_key_up(scancode, _extended);
}
 ...
 * @param {any} _heading
 */
export function rdp_location_data(_lat, _lon, _alt, _accuracy, _speed, _heading) {
    wasm.rdp_location_data(_lat, _lon, _alt, _accuracy, _speed, _heading);
}
 ...
 * @param {number} y
 */
export function rdp_mouse_down(button, x, y) {
    wasm.rdp_mouse_down(button, x, y);
}
 ...
 * @param {number} y
 */
export function rdp_mouse_h_scroll(delta, x, y) {
    wasm.rdp_mouse_h_scroll(delta, x, y);
}
 ...
 * @param {number} y
 */
export function rdp_mouse_move(x, y) {
    wasm.rdp_mouse_move(x, y);
}
 ...
 * @param {number} y
 */
export function rdp_mouse_up(button, x, y) {
    wasm.rdp_mouse_up(button, x, y);
}
 ...
 * @param {number} y
 */
export function rdp_mouse_wheel(delta, x, y) {
    wasm.rdp_mouse_wheel(delta, x, y);
}

export function rdp_notify_files_changed() {
    wasm.rdp_notify_files_changed();
}
 ...
 * @param {number} height
 */
export function rdp_resize_display(width, height) {
    wasm.rdp_resize_display(width, height);
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_call_d118afd8bd2557eb: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5) {
        ...
        __wbg_new_typed_1824d93f294193e5: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h5ac8ee271e8fa147(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 3843, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hd61fc87c188b81b0);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("CloseEvent")], shim_idx: 1005, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd);
            return ret;
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Event")], shim_idx: 1005, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd_2);
            return ret;
        },
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("MessageEvent")], shim_idx: 1005, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd_3);
            return ret;
        },
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 1003, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h78dca7c1a7923583);
            return ret;
        },
        __wbindgen_cast_0000000000000006: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h858026b36b08274a);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./rdp_client_wasm_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h78dca7c1a7923583(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h78dca7c1a7923583(arg0, arg1);
}

function wasm_bindgen__convert__closures_____invoke__h858026b36b08274a(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h858026b36b08274a(arg0, arg1);
}

function wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd_2(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd_2(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd_3(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h1473a5b3cad4c3fd_3(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__hd61fc87c188b81b0(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__hd61fc87c188b81b0(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h5ac8ee271e8fa147(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h5ac8ee271e8fa147(arg0, arg1, arg2, arg3);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rdp_client_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
