...
} from './ssh-keyboard/index.js?v=20260721-kb-syntax1';
...
} from './terminal-scroll-policy.js?v=20260721-kb-syntax1';
import { createTerminalSurfaceController } from './terminal-surface-controller.js?v=20260721-kb-syntax1';
...
async function initWTerm(connectionToken = activeConnectionToken, { followOnConnect = true } = {}) {
    ...
    try {
        await import('/vendor/wterm-fork/core/xterm-headless-register.js?v=20260721-kb-syntax1');
    } catch (err) {
    ...
    try {
        ...
        const module = await import('/vendor/wterm-fork/index.js?v=20260721-kb-syntax1');
