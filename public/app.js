...
import { createNotesController } from './notes.js?v=20260913-liquid-glass29';
...
import { t, initI18n, setLocale, getLocale, applyDomI18n, onLocaleChange, formatDateTime } from './i18n/runtime.js?v=20260913-liquid-glass29';
import { localizeActivityMessage } from './activity-i18n.js?v=20260913-liquid-glass29';
        ...
        frame.src = session.page === 'rdp'
            ...
            : session.page === 'novnc'
                ...
                : session.page === 'telnet-terminal'
                    ? `/telnet-terminal.html?embed=1&tabId=${encodeURIComponent(session.id)}&v=20260913-liquid-glass29`
                    : `/terminal.html?embed=1&tabId=${encodeURIComponent(session.id)}&v=20260913-liquid-glass29`;
