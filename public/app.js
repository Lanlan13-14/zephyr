...
import { createNotesController } from './notes.js?v=20260902-monitor-docker1';
...
import { t, initI18n, setLocale, getLocale, applyDomI18n, onLocaleChange, formatDateTime } from './i18n/runtime.js?v=20260902-monitor-docker1';
import { localizeActivityMessage } from './activity-i18n.js?v=20260902-monitor-docker1';
...
function renderConnections() {
    ...
    $('#connectionGrid').innerHTML = list.length ? list.map((c) => {
        ...
        return `<article class="connection-card"><div class="card-top"><span class="protocol-badge ${escapeHtml(String(c.protocol || '').toLowerCase())}">${escapeHtml(c.protocol)}</span><div class="card-top-meta">${sourceBadge}<span class="last-time">${fmtTime(c.lastConnectedAt)}</span></div></div>
        ...
        frame.src = session.page === 'rdp'
            ...
            : session.page === 'novnc'
                ...
                : session.page === 'telnet-terminal'
                    ? `/telnet-terminal.html?embed=1&tabId=${encodeURIComponent(session.id)}&v=20260902-monitor-docker1`
                    : `/terminal.html?embed=1&tabId=${encodeURIComponent(session.id)}&v=20260902-monitor-docker1`;
