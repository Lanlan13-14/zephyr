...
test('app.js imports i18n runtime and bootstraps in init()', () => {
    ...
    assert.match(js, /from '\.\/i18n\/runtime\.js\?v=20260727-password-code-button1'/);
...
test('app.html cache busts include current i18n fix revision', () => {
    const html = read('public/app.html');
    assert.match(html, /app\.js\?v=20260727-password-code-button1/);
    assert.match(html, /style\.css\?v=20260727-password-code-button1/);
    assert.match(html, /i18n\/runtime\.js\?v=20260727-password-code-button1/);
});
