...
test('canonical tool catalog and executor use the same strict schemas', () => {
    ...
    for (const name of ['connection_list_v1', 'connection_get_v1', 'connection_rename_v1', 'connection_create_v1', 'connection_update_v1', 'connection_delete_v1', 'connection_test_v1', 'connection_open_v1', 'proxy_list_v1', 'proxy_get_v1', 'proxy_create_v1', 'proxy_update_v1', 'proxy_delete_v1', 'ssh_key_list_v1', 'ssh_key_get_v1', 'ssh_key_validate_v1', 'ssh_key_rename_v1', 'ssh_key_update_metadata_v1', 'ssh_key_delete_v1', 'jump_host_list_v1', 'jump_host_get_v1', 'jump_host_create_v1', 'jump_host_update_v1', 'jump_host_delete_v1', 'snippet_list_v1', 'snippet_get_v1', 'snippet_create_v1', 'snippet_update_v1', 'snippet_delete_v1', 'terminal_read_v1', 'terminal_send_v1', 'terminal_wait_v1', 'browser_inspect_v1', 'browser_click_v1', 'browser_type_v1', 'remote_desktop_capture_v1', 'remote_desktop_action_v1', 'remote_desktop_verify_v1', 'agent_list_v1', 'agent_get_v1', 'agent_file_list_v1', 'agent_file_stat_v1', 'agent_file_read_text_v1', 'agent_file_mkdir_v1', 'agent_file_rename_v1', 'agent_file_delete_v1', 'secret_ref_list_v1']) {
