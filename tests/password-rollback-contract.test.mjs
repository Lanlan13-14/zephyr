...
test('rollback landing page markup and client follow i18n and post the token', () => {
    ...
    assert.match(html, /src="\/password-rollback\.js\?v=20260727-ai-terminal-session1" type="module"/);
    const js = read('public/password-rollback.js');
    assert.match(js, /import \{ t, initI18n \} from '\.\/i18n\/runtime\.js\?v=20260727-ai-terminal-session1';/);
