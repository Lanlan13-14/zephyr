...
test('updated app and terminal assets use the current cache revision', () => {
    assert.match(appHtml, /app\.js\?v=20260730-toast-motion4/);
    assert.match(terminalHtml, /terminal\.js\?v=20260730-toast-motion4/);
    assert.match(telnetHtml, /telnet-terminal\.js\?v=20260730-toast-motion4/);
    assert.match(sw, /zephyr-static-20260730-toast-motion4/);
});
