...
/// lens: blur, specular rim, inner highlight, press scale, velocity squash.
/// Drag is 1:1; release hands velocity to a spring. Tap (no drag) flips.
...
class _LiquidToggleState extends State<LiquidToggle>
  ...
  Widget build(BuildContext context) {
    ...
    final on = brightness == Brightness.light
        ? const Color(0xFF34C759)
        : const Color(0xFF30D158);
    final off = brightness == Brightness.light
    ...
    final track = Color.lerp(off, Color.lerp(on, accent, 0.35)!, t)!;
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Transform.scale(
                    scaleX: scaleX,
                    scaleY: scaleY,
                    child: _GlassThumb(press: press, brightness: brightness),
                  ),
                ),
              ],
            ),
...
class _GlassThumb extends StatelessWidget {
  ...
  const _GlassThumb({required this.press, required this.brightness});
