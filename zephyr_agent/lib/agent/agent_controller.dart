...
class AgentController extends ChangeNotifier {
  ...
  void _sendHello() {
    ...
    _send({
      ...
      'capabilities': {
        'read': _config.fileSharingEnabled,
        'write': _config.fileSharingEnabled && !_config.readOnly,
        'delete': _config.fileSharingEnabled && !_config.readOnly,
        'rename': _config.fileSharingEnabled && !_config.readOnly,
        'mkdir': _config.fileSharingEnabled && !_config.readOnly,
        'truncate': _config.fileSharingEnabled && !_config.readOnly,
        'binary': _config.fileSharingEnabled,
        'binaryRead': _config.fileSharingEnabled,
        'binaryWrite': _config.fileSharingEnabled && !_config.readOnly,
        'cancel': true,
        'creditFlow': true,
